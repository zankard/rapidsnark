...
template <typename BaseField>
Curve<BaseField>::Curve(BaseField& aF, typename BaseField::Element& aa,
                        typename BaseField::Element& ab,
                        typename BaseField::Element& agx,
                        typename BaseField::Element& agy)
    : F(aF)
...
template <typename BaseField>
Curve<BaseField>::Curve(BaseField& aF, std::string as, std::string bs,
                        std::string gxs, std::string gys)
    : F(aF)
{
    F = aF;
...
template <typename BaseField>
void Curve<BaseField>::initCurve(typename BaseField::Element& aa,
                                 typename BaseField::Element& ab,
                                 typename BaseField::Element& agx,
                                 typename BaseField::Element& agy)
{
...
template <typename BaseField>
void inline Curve<BaseField>::mulByA(typename BaseField::Element& r,
                                     typename BaseField::Element& ab)
{
    switch (typeOfA)
    {
...
std::string Curve<BaseField>::toString(Point& p, uint32_t radix)
{
    ...
    stringStream << "(" << F.toString(tmp.x, radix) << ","
                 << F.toString(tmp.y, radix) << ")";
