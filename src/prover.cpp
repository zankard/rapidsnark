...
static size_t ProofBufferMinSize() { return 810; }

static size_t PublicBufferMinSize(size_t count) { return count * 82 + 4; }
...
unsigned long CalcPublicBufferSize(const void*   zkey_buffer,
                   ...
                   char* error_msg, unsigned long error_msg_maxsize)
{
    try
    {
        ...
        auto prover = Groth16::makeProver<AltBn128::Engine>(
            zkeyHeader->nVars, zkeyHeader->nPublic, zkeyHeader->domainSize,
            zkeyHeader->nCoefs, zkeyHeader->vk_alpha1, zkeyHeader->vk_beta1,
            zkeyHeader->vk_beta2, zkeyHeader->vk_delta1, zkeyHeader->vk_delta2,
        ...
        std::string stringPublic =
            BuildPublicString(wtnsData, zkeyHeader->nPublic);
